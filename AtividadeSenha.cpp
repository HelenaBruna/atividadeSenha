// AtividadeSenha.cpp : Este arquivo contém a função 'main'. A execução do programa começa e termina ali.
//
...
int main()
{
	...
	do
	{
		...
		case 0:
			...
			break;
		case 1:
			cout << "--- GERANDO SENHA ---" << endl << endl;
			enqueue(senhaGeradas, rand());
			break;
		case 2:
			cout << "--- RELIZANDO ATENDIMENTO ---" << endl << endl;
			cout << "Senha: " << valor(senhaGeradas) << endl;
			enqueue(senhaAtendidas, valor(senhaGeradas));
			dequeue(senhaGeradas);
			cout << "Quantidade de senha aguardando atendimento: " << count(senhaGeradas) << endl << endl;
			break;
		default:
